...
val SQL_DELETE_TABLE_USER = "DROP TABLE IF EXISTS $TABLE_NAME_USER"

class DbUserHandler(var context: Context): SQLiteOpenHelper(context,
    DATABASE_NAME_USER, null,
    DATABASE_VERSION_USER
) {
    ...
    fun checkUser(email: String, password: String): MutableList<User> {
        ...
        try {
            ...
            Toast.makeText(context, "Какие-то проблемки/не совпадают", Toast.LENGTH_SHORT).show()
        }
        return list
    }
/*
